...
class QuestionModelTest(TestCase):
    ...
    def test_was_published_recently_with_future_questions(self):
        ''''
        was_published_recentetly returns False for questions 
...
def create_question(question_text, days):
    '''
    Create a question with the given "question_text", and publisehd the given number 
...
class QuestionIndexViweTest(TestCase):
    ...
    def test_two_future_questions(self):
        '''
        The question index page may display multiple future questions.
        '''
...
class QuestionDetailViewTest(TestCase):
    def test_future_question(self):
        '''
        Then detail view of a question with a pub_date in the future
    ...
    def test_past_question(self):
        '''
        Then detail view of a question with a pub_date in the past
